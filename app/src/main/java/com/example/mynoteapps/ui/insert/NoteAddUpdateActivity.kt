...
class NoteAddUpdateActivity : AppCompatActivity() {
        ...
        if (isEdit){
            ...
            if (note != null){
                note?.let {note ->
                    ...
                    binding?.edtDescription?.setText(note.descreiption)
                }
            }
        }else{
    ...
    private fun showAlertDialog(type: Int){
        ...
        val alertDialogBulder = AlertDialog.Builder(this)
        with(alertDialogBulder){
            ...
            val alertDialog = alertDialogBulder.create()
            alertDialog.show()
        }
    }
}